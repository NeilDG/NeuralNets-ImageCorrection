...
class WarpCNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(in_channels = 3, out_channels = 64, kernel_size = 6, stride = 1, padding = 1)
        self.pool2 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0)
        
        self.conv3 = nn.Conv2d(in_channels = 3, out_channels = 64, kernel_size = 8, stride = 1, padding = 1)
        self.pool3 = nn.MaxPool2d(kernel_size=4, stride=2, padding=0)
        
        print("output size:", self.outputSize(gv.IMAGE_W,3,1,1))
