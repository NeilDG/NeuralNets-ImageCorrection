...
class WarpCNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(in_channels = 64, out_channels = 32, kernel_size = 5, stride = 3, padding = 1)
        self.pool2 = nn.MaxPool2d(kernel_size=5, stride=2, padding=0)
        
        self.conv3 = nn.Conv2d(in_channels = 32, out_channels = 32, kernel_size = 3, stride = 3, padding = 1)
        self.pool3 = nn.MaxPool2d(kernel_size=3, stride=2, padding=0)
        
        self.conv4 = nn.Conv2d(in_channels = 32, out_channels = 16, kernel_size = 2, stride = 2, padding = 1)
        self.pool4 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0)
        
        self.conv5 = nn.Conv2d(in_channels = 16, out_channels = 8, kernel_size = 2, stride = 2, padding = 1)
